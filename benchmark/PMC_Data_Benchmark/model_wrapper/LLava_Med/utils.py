...
def load_pretrained_model(model_path, model_base, model_name, load_8bit=False, load_4bit=False, device_map="auto", device="cuda", cache_dir=None):
    ...
    if 'llava' in model_name.lower():
        ...
        if model_base is not None:
            ...
            model = AutoModelForCausalLM.from_pretrained(model_base, low_cpu_mem_usage=True, **kwargs, cache_dir=cache_dir)
