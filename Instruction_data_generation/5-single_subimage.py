...
output_dir = '<YOUR_OUTPUT_DIR>/PMC_Insturction_Data/stage5_single_subimage'  # Save output in the same directory as input
input_filename = os.path.basename(input_file)  # Extract filename

# Extract index from filename 
file_index = re.search(r'final_instruction_single_subimage_QA_(\d+)\.json$', input_filename)
